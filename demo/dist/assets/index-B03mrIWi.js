...
void main() {
	...
	`}function ES(s){let e=new WeakMap,n=null;function r(d){if(d&&d.isTexture){const p=d.mapping,m=p===hf||p===pf,g=p===Bs||p===zs;if(m||g){let x=e.get(d);const y=x!==void 0?x.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==y)return n===null&&(n=new am(s)),x=m?n.fromEquirectangular(d,x):n.fromCubemap(d,x),x.texture.pmremVersion=d.pmremVersion,e.set(d,x),x.texture;if(x!==void 0)return x.texture;{const S=d.image;return m&&S&&S.height>0||g&&S&&a(S)?(n===null&&(n=new am(s)),x=m?n.fromEquirectangular(d):n.fromCubemap(d),x.texture.pmremVersion=d.pmremVersion,e.set(d,x),d.addEventListener("dispose",u),x.texture):null}}}return d}function a(d){let p=0;const m=6;for(let g=0;g<m;g++)d[g]!==void 0&&p++;return p===m}function u(d){const p=d.target;p.removeEventListener("dispose",u);const m=e.get(p);m!==void 0&&(e.delete(p),m.dispose())}function f(){e=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:f}}function TS(s){const e={};function n(r){if(e[r]!==void 0)return e[r];let a;switch(r){case"WEBGL_depth_texture":a=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":a=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":a=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":a=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:a=s.getExtension(r)}return e[r]=a,a}return{has:function(r){return n(r)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(r){const a=n(r);return a===null&&Rl("THREE.WebGLRenderer: "+r+" extension not supported."),a}}}function wS(s,e,n,r){const a={},u=new WeakMap;function f(x){const y=x.target;y.index!==null&&e.remove(y.index);for(const w in y.attributes)e.remove(y.attributes[w]);for(const w in y.morphAttributes){const A=y.morphAttributes[w];for(let v=0,_=A.length;v<_;v++)e.remove(A[v])}y.removeEventListener("dispose",f),delete a[y.id];const S=u.get(y);S&&(e.remove(S),u.delete(y)),r.releaseStatesOfGeometry(y),y.isInstancedBufferGeometry===!0&&delete y._maxInstanceCount,n.memory.geometries--}function d(x,y){return a[y.id]===!0||(y.addEventListener("dispose",f),a[y.id]=!0,n.memory.geometries++),y}function p(x){const y=x.attributes;for(const w in y)e.update(y[w],s.ARRAY_BUFFER);const S=x.morphAttributes;for(const w in S){const A=S[w];for(let v=0,_=A.length;v<_;v++)e.update(A[v],s.ARRAY_BUFFER)}}function m(x){const y=[],S=x.index,w=x.attributes.position;let A=0;if(S!==null){const I=S.array;A=S.version;for(let P=0,N=I.length;P<N;P+=3){const J=I[P+0],z=I[P+1],U=I[P+2];y.push(J,z,z,U,U,J)}}else if(w!==void 0){const I=w.array;A=w.version;for(let P=0,N=I.length/3-1;P<N;P+=3){const J=P+0,z=P+1,U=P+2;y.push(J,z,z,U,U,J)}}else return;const v=new(eg(y)?ag:og)(y,1);v.version=A;const _=u.get(x);_&&e.remove(_),u.set(x,v)}function g(x){const y=u.get(x);if(y){const S=x.index;S!==null&&y.version<S.version&&m(x)}else m(x);return u.get(x)}return{get:d,update:p,getWireframeAttribute:g}}function AS(s,e,n){let r;function a(y){r=y}let u,f;function d(y){u=y.type,f=y.bytesPerElement}function p(y,S){s.drawElements(r,S,u,y*f),n.update(S,r,1)}function m(y,S,w){w!==0&&(s.drawElementsInstanced(r,S,u,y*f,w),n.update(S,r,w))}function g(y,S,w){if(w===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,S,0,u,y,0,w);let v=0;for(let _=0;_<w;_++)v+=S[_];n.update(v,r,1)}function x(y,S,w,A){if(w===0)return;const v=e.get("WEBGL_multi_draw");if(v===null)for(let _=0;_<y.length;_++)m(y[_]/f,S[_],A[_]);else{v.multiDrawElementsInstancedWEBGL(r,S,0,u,y,0,A,0,w);let _=0;for(let I=0;I<w;I++)_+=S[I];for(let I=0;I<A.length;I++)n.update(_,r,A[I])}}this.setMode=a,this.setIndex=d,this.render=p,this.renderInstances=m,this.renderMultiDraw=g,this.renderMultiDrawInstances=x}function CS(s){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function r(u,f,d){switch(n.calls++,f){case s.TRIANGLES:n.triangles+=d*(u/3);break;case s.LINES:n.lines+=d*(u/2);break;case s.LINE_STRIP:n.lines+=d*(u-1);break;case s.LINE_LOOP:n.lines+=d*u;break;case s.POINTS:n.points+=d*u;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",f);break}}function a(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:a,update:r}}function RS(s,e,n){const r=new WeakMap,a=new Ht;function u(f,d,p){const m=f.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,x=g!==void 0?g.length:0;let y=r.get(d);if(y===void 0||y.count!==x){let E=function(){Y.dispose(),r.delete(d),d.removeEventListener("dispose",E)};var S=E;y!==void 0&&y.texture.dispose();const w=d.morphAttributes.position!==void 0,A=d.morphAttributes.normal!==void 0,v=d.morphAttributes.color!==void 0,_=d.morphAttributes.position||[],I=d.morphAttributes.normal||[],P=d.morphAttributes.color||[];let N=0;w===!0&&(N=1),A===!0&&(N=2),v===!0&&(N=3);let J=d.attributes.position.count*N,z=1;J>e.maxTextureSize&&(z=Math.ceil(J/e.maxTextureSize),J=e.maxTextureSize);const U=new Float32Array(J*z*4*x),Y=new ng(U,J,z,x);Y.type=Ii,Y.needsUpdate=!0;const Se=N*4;for(let R=0;R<x;R++){const ie=_[R],ee=I[R],ue=P[R],fe=J*z*4*R;for(let te=0;te<ie.count;te++){const le=te*Se;w===!0&&(a.fromBufferAttribute(ie,te),U[fe+le+0]=a.x,U[fe+le+1]=a.y,U[fe+le+2]=a.z,U[fe+le+3]=0),A===!0&&(a.fromBufferAttribute(ee,te),U[fe+le+4]=a.x,U[fe+le+5]=a.y,U[fe+le+6]=a.z,U[fe+le+7]=0),v===!0&&(a.fromBufferAttribute(ue,te),U[fe+le+8]=a.x,U[fe+le+9]=a.y,U[fe+le+10]=a.z,U[fe+le+11]=ue.itemSize===4?a.w:1)}}y={count:x,texture:Y,size:new At(J,z)},r.set(d,y),d.addEventListener("dispose",E)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",f.morphTexture,n);else{let w=0;for(let v=0;v<m.length;v++)w+=m[v];const A=d.morphTargetsRelative?1:1-w;p.getUniforms().setValue(s,"morphTargetBaseInfluence",A),p.getUniforms().setValue(s,"morphTargetInfluences",m)}p.getUniforms().setValue(s,"morphTargetsTexture",y.texture,n),p.getUniforms().setValue(s,"morphTargetsTextureSize",y.size)}return{update:u}}function PS(s,e,n,r){let a=new WeakMap;function u(p){const m=r.render.frame,g=p.geometry,x=e.get(p,g);if(a.get(x)!==m&&(e.update(x),a.set(x,m)),p.isInstancedMesh&&(p.hasEventListener("dispose",d)===!1&&p.addEventListener("dispose",d),a.get(p)!==m&&(n.update(p.instanceMatrix,s.ARRAY_BUFFER),p.instanceColor!==null&&n.update(p.instanceColor,s.ARRAY_BUFFER),a.set(p,m))),p.isSkinnedMesh){const y=p.skeleton;a.get(y)!==m&&(y.update(),a.set(y,m))}return x}function f(){a=new WeakMap}function d(p){const m=p.target;m.removeEventListener("dispose",d),n.remove(m.instanceMatrix),m.instanceColor!==null&&n.remove(m.instanceColor)}return{update:u,dispose:f}}class pg extends Rn{constructor(e,n,r,a,u,f,d,p,m,g=Fs){if(g!==Fs&&g!==Vs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");r===void 0&&g===Fs&&(r=Xr),r===void 0&&g===Vs&&(r=Hs),super(null,a,u,f,d,p,g,r,m),this.isDepthTexture=!0,this.image={width:e,height:n},this.magFilter=d!==void 0?d:Xn,this.minFilter=p!==void 0?p:Xn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const n=super.toJSON(e);return this.compareFunction!==null&&(n.compareFunction=this.compareFunction),n}}const mg=new Rn,fm=new pg(1,1),gg=new ng,vg=new m0,_g=new cg,dm=[],hm=[],pm=new Float32Array(16),mm=new Float32Array(9),gm=new Float32Array(4);function Ys(s,e,n){const r=s[0];if(r<=0||r>0)return s;const a=e*n;let u=dm[a];if(u===void 0&&(u=new Float32Array(a),dm[a]=u),e!==0){r.toArray(u,0);for(let f=1,d=0;f!==e;++f)d+=n,s[f].toArray(u,d)}return u}function Yt(s,e){if(s.length!==e.length)return!1;for(let n=0,r=s.length;n<r;n++)if(s[n]!==e[n])return!1;return!0}function qt(s,e){for(let n=0,r=e.length;n<r;n++)s[n]=e[n]}function Vl(s,e){let n=hm[e];n===void 0&&(n=new Int32Array(e),hm[e]=n);for(let r=0;r!==e;++r)n[r]=s.allocateTextureUnit();return n}function bS(s,e){const n=this.cache;n[0]!==e&&(s.uniform1f(this.addr,e),n[0]=e)}function LS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Yt(n,e))return;s.uniform2fv(this.addr,e),qt(n,e)}}function DS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Yt(n,e))return;s.uniform3fv(this.addr,e),qt(n,e)}}function NS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Yt(n,e))return;s.uniform4fv(this.addr,e),qt(n,e)}}function IS(s,e){const n=this.cache,r=e.elements;if(r===void 0){if(Yt(n,e))return;s.uniformMatrix2fv(this.addr,!1,e),qt(n,e)}else{if(Yt(n,r))return;gm.set(r),s.uniformMatrix2fv(this.addr,!1,gm),qt(n,r)}}function US(s,e){const n=this.cache,r=e.elements;if(r===void 0){if(Yt(n,e))return;s.uniformMatrix3fv(this.addr,!1,e),qt(n,e)}else{if(Yt(n,r))return;mm.set(r),s.uniformMatrix3fv(this.addr,!1,mm),qt(n,r)}}function FS(s,e){const n=this.cache,r=e.elements;if(r===void 0){if(Yt(n,e))return;s.uniformMatrix4fv(this.addr,!1,e),qt(n,e)}else{if(Yt(n,r))return;pm.set(r),s.uniformMatrix4fv(this.addr,!1,pm),qt(n,r)}}function OS(s,e){const n=this.cache;n[0]!==e&&(s.uniform1i(this.addr,e),n[0]=e)}function kS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Yt(n,e))return;s.uniform2iv(this.addr,e),qt(n,e)}}function BS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Yt(n,e))return;s.uniform3iv(this.addr,e),qt(n,e)}}function zS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Yt(n,e))return;s.uniform4iv(this.addr,e),qt(n,e)}}function HS(s,e){const n=this.cache;n[0]!==e&&(s.uniform1ui(this.addr,e),n[0]=e)}function VS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Yt(n,e))return;s.uniform2uiv(this.addr,e),qt(n,e)}}function GS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Yt(n,e))return;s.uniform3uiv(this.addr,e),qt(n,e)}}function WS(s,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Yt(n,e))return;s.uniform4uiv(this.addr,e),qt(n,e)}}function XS(s,e,n){const r=this.cache,a=n.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a);let u;this.type===s.SAMPLER_2D_SHADOW?(fm.compareFunction=Jm,u=fm):u=mg,n.setTexture2D(e||u,a)}function jS(s,e,n){const r=this.cache,a=n.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a),n.setTexture3D(e||vg,a)}function YS(s,e,n){const r=this.cache,a=n.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a),n.setTextureCube(e||_g,a)}function qS(s,e,n){const r=this.cache,a=n.allocateTextureUnit();r[0]!==a&&(s.uniform1i(this.addr,a),r[0]=a),n.setTexture2DArray(e||gg,a)}function KS(s){switch(s){case 5126:return bS;case 35664:return LS;case 35665:return DS;case 35666:return NS;case 35674:return IS;case 35675:return US;case 35676:return FS;case 5124:case 35670:return OS;case 35667:case 35671:return kS;case 35668:case 35672:return BS;case 35669:case 35673:return zS;case 5125:return HS;case 36294:return VS;case 36295:return GS;case 36296:return WS;case 35678:case 36198:case 36298:case 36306:case 35682:return XS;case 35679:case 36299:case 36307:return jS;case 35680:case 36300:case 36308:case 36293:return YS;case 36289:case 36303:case 36311:case 36292:return qS}}function $S(s,e){s.uniform1fv(this.addr,e)}function ZS(s,e){const n=Ys(e,this.size,2);s.uniform2fv(this.addr,n)}function QS(s,e){const n=Ys(e,this.size,3);s.uniform3fv(this.addr,n)}function JS(s,e){const n=Ys(e,this.size,4);s.uniform4fv(this.addr,n)}function eM(s,e){const n=Ys(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,n)}function tM(s,e){const n=Ys(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,n)}function nM(s,e){const n=Ys(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,n)}function iM(s,e){s.uniform1iv(this.addr,e)}function rM(s,e){s.uniform2iv(this.addr,e)}function sM(s,e){s.uniform3iv(this.addr,e)}function oM(s,e){s.uniform4iv(this.addr,e)}function aM(s,e){s.uniform1uiv(this.addr,e)}function lM(s,e){s.uniform2uiv(this.addr,e)}function uM(s,e){s.uniform3uiv(this.addr,e)}function cM(s,e){s.uniform4uiv(this.addr,e)}function fM(s,e,n){const r=this.cache,a=e.length,u=Vl(n,a);Yt(r,u)||(s.uniform1iv(this.addr,u),qt(r,u));for(let f=0;f!==a;++f)n.setTexture2D(e[f]||mg,u[f])}function dM(s,e,n){const r=this.cache,a=e.length,u=Vl(n,a);Yt(r,u)||(s.uniform1iv(this.addr,u),qt(r,u));for(let f=0;f!==a;++f)n.setTexture3D(e[f]||vg,u[f])}function hM(s,e,n){const r=this.cache,a=e.length,u=Vl(n,a);Yt(r,u)||(s.uniform1iv(this.addr,u),qt(r,u));for(let f=0;f!==a;++f)n.setTextureCube(e[f]||_g,u[f])}function pM(s,e,n){const r=this.cache,a=e.length,u=Vl(n,a);Yt(r,u)||(s.uniform1iv(this.addr,u),qt(r,u));for(let f=0;f!==a;++f)n.setTexture2DArray(e[f]||gg,u[f])}function mM(s){switch(s){case 5126:return $S;case 35664:return ZS;case 35665:return QS;case 35666:return JS;case 35674:return eM;case 35675:return tM;case 35676:return nM;case 5124:case 35670:return iM;case 35667:case 35671:return rM;case 35668:case 35672:return sM;case 35669:case 35673:return oM;case 5125:return aM;case 36294:return lM;case 36295:return uM;case 36296:return cM;case 35678:case 36198:case 36298:case 36306:case 35682:return fM;case 35679:case 36299:case 36307:return dM;case 35680:case 36300:case 36308:case 36293:return hM;case 36289:case 36303:case 36311:case 36292:return pM}}class gM{constructor(e,n,r){this.id=e,this.addr=r,this.cache=[],this.type=n.type,this.setValue=KS(n.type)}}class vM{constructor(e,n,r){this.id=e,this.addr=r,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=mM(n.type)}}class _M{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,r){const a=this.seq;for(let u=0,f=a.length;u!==f;++u){const d=a[u];d.setValue(e,n[d.id],r)}}}const ef=/(\w+)(\])?(\[|\.)?/g;function vm(s,e){s.seq.push(e),s.map[e.id]=e}function xM(s,e,n){const r=s.name,a=r.length;for(ef.lastIndex=0;;){const u=ef.exec(r),f=ef.lastIndex;let d=u[1];const p=u[2]==="]",m=u[3];if(p&&(d=d|0),m===void 0||m==="["&&f+2===a){vm(n,m===void 0?new gM(d,s,e):new vM(d,s,e));break}else{let x=n.map[d];x===void 0&&(x=new _M(d),vm(n,x)),n=x}}}class Pl{constructor(e,n){this.seq=[],this.map={};const r=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let a=0;a<r;++a){const u=e.getActiveUniform(n,a),f=e.getUniformLocation(n,u.name);xM(u,f,this)}}setValue(e,n,r,a){const u=this.map[n];u!==void 0&&u.setValue(e,r,a)}setOptional(e,n,r){const a=n[r];a!==void 0&&this.setValue(e,r,a)}static upload(e,n,r,a){for(let u=0,f=n.length;u!==f;++u){const d=n[u],p=r[d.id];p.needsUpdate!==!1&&d.setValue(e,p.value,a)}}static seqWithValue(e,n){const r=[];for(let a=0,u=e.length;a!==u;++a){const f=e[a];f.id in n&&r.push(f)}return r}}function _m(s,e,n){const r=s.createShader(e);return s.shaderSource(r,n),s.compileShader(r),r}const yM=37297;let SM=0;function MM(s,e){const n=s.split(`
`),r=[],a=Math.max(e-6,0),u=Math.min(e+6,n.length);for(let f=a;f<u;f++){const d=f+1;r.push(`${d===e?">":" "} ${d}: ${n[f]}`)}return r.join(`
`)}function EM(s){const e=Mt.getPrimaries(Mt.workingColorSpace),n=Mt.getPrimaries(s);let r;switch(e===n?r="":e===Il&&n===Nl?r="LinearDisplayP3ToLinearSRGB":e===Nl&&n===Il&&(r="LinearSRGBToLinearDisplayP3"),s){case _r:case zl:return[r,"LinearTransferOETF"];case hi:case td:return[r,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",s),[r,"LinearTransferOETF"]}}function xm(s,e,n){const r=s.getShaderParameter(e,s.COMPILE_STATUS),a=s.getShaderInfoLog(e).trim();if(r&&a==="")return"";const u=/ERROR: 0:(\d+)/.exec(a);if(u){const f=parseInt(u[1]);return n.toUpperCase()+`

`+a+`

`+MM(s.getShaderSource(e),f)}else return a}function TM(s,e){const n=EM(e);return`vec4 ${s}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function wM(s,e){let n;switch(e){case z_:n="Linear";break;case H_:n="Reinhard";break;case V_:n="Cineon";break;case G_:n="ACESFilmic";break;case X_:n="AgX";break;case j_:n="Neutral";break;case W_:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+s+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const vl=new Q;function AM(){Mt.getLuminanceCoefficients(vl);const s=vl.x.toFixed(4),e=vl.y.toFixed(4),n=vl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function CM(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ko).join(`
`)}function RM(s){const e=[];for(const n in s){const r=s[n];r!==!1&&e.push("#define "+n+" "+r)}return e.join(`
`)}function PM(s,e){const n={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let a=0;a<r;a++){const u=s.getActiveAttrib(e,a),f=u.name;let d=1;u.type===s.FLOAT_MAT2&&(d=2),u.type===s.FLOAT_MAT3&&(d=3),u.type===s.FLOAT_MAT4&&(d=4),n[f]={type:u.type,location:s.getAttribLocation(e,f),locationSize:d}}return n}function ko(s){return s!==""}function ym(s,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Sm(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const bM=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wf(s){return s.replace(bM,DM)}const LM=new Map;function DM(s,e){let n=rt[e];if(n===void 0){const r=LM.get(e);if(r!==void 0)n=rt[r],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return Wf(n)}const NM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Mm(s){return s.replace(NM,IM)}function IM(s,e,n,r){let a="";for(let u=parseInt(e);u<parseInt(n);u++)a+=r.replace(/\[\s*i\s*\]/g,"[ "+u+" ]").replace(/UNROLLED_LOOP_INDEX/g,u);return a}function Em(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function UM(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===zm?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===x_?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Di&&(e="SHADOWMAP_TYPE_VSM"),e}function FM(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Bs:case zs:e="ENVMAP_TYPE_CUBE";break;case Bl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function OM(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===zs&&(e="ENVMAP_MODE_REFRACTION"),e}function kM(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Hm:e="ENVMAP_BLENDING_MULTIPLY";break;case k_:e="ENVMAP_BLENDING_MIX";break;case B_:e="ENVMAP_BLENDING_ADD";break}return e}function BM(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:r,maxMip:n}}function zM(s,e,n,r){const a=s.getContext(),u=n.defines;let f=n.vertexShader,d=n.fragmentShader;const p=UM(n),m=FM(n),g=OM(n),x=kM(n),y=BM(n),S=CM(n),w=RM(u),A=a.createProgram();let v,_,I=n.glslVersion?"#version "+n.glslVersion+`
`:"";n.isRawShaderMaterial?(v=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,w].filter(ko).join(`
`),v.length>0&&(v+=`
`),_=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,w].filter(ko).join(`
`),_.length>0&&(_+=`
...
`,xg=({mode:s="fullscreen",className:e=""})=>{const{engine:n,theme:r}=Ws(),a=on.useRef(null),u=on.useRef(),[f,d]=on.useState(0);on.useEffect(()=>{if(!a.current||!n)return;const m=a.current,g=s==="fullscreen",x=new xE({antialias:!0,alpha:!0,powerPreference:"high-performance"});x.setPixelRatio(Math.min(window.devicePixelRatio,2));const y=()=>{const R=g?window.innerWidth:m.clientWidth,ie=g?window.innerHeight:m.clientHeight;return x.setSize(R,ie),{width:R,height:ie}},S=y();x.setClearColor(0,0),m.appendChild(x.domElement),u.current=x;const w=new yE,A=new hg(-S.width/2,S.width/2,S.height/2,-S.height/2,.1,1e3);A.position.z=10;const v=new ai,_=new mi({vertexShader:AE,fragmentShader:CE,transparent:!0,blending:Ll,depthWrite:!1,uniforms:{uTime:{value:0},uAccent:{value:new xt(r==="mission"?15907131:3463423)},uGlowIntensity:{value:2.5},uSize:{value:g?10:6}}}),I=new wE(v,_);w.add(I);const P=new ai,N=new mi({vertexShader:RE,fragmentShader:PE,transparent:!0,blending:Ll,depthWrite:!1,uniforms:{uTime:{value:0},uAccent:{value:new xt(r==="mission"?15907131:3463423)}}}),J=new EE(P,N);w.add(J);let z=0,U=performance.now();const Y=n.subscribe(R=>{const{nodes:ie,edges:ee,activeEdges:ue}=R,fe=x.getSize(new At),te=new Float32Array(ie.length*3),le=new Float32Array(ie.length);ie.forEach((D,ne)=>{te[ne*3]=D.position[0]-fe.x/2,te[ne*3+1]=D.position[1]-fe.y/2,te[ne*3+2]=D.position[2],le[ne]=D.energy}),v.setAttribute("position",new An(te,3)),v.setAttribute("aEnergy",new An(le,1));const O=new Float32Array(ee.length*6),ce=new Float32Array(ee.length*2);ee.forEach((D,ne)=>{const Pe=ie[D.from],j=ie[D.to];if(Pe&&j){const ae=ne*6;O[ae]=Pe.position[0]-fe.x/2,O[ae+1]=Pe.position[1]-fe.y/2,O[ae+2]=Pe.position[2],O[ae+3]=j.position[0]-fe.x/2,O[ae+4]=j.position[1]-fe.y/2,O[ae+5]=j.position[2];const xe=[D.from,D.to].sort((be,Le)=>be-Le).join("-"),ye=ue.has(xe)?1:0;ce[ne*2]=ye,ce[ne*2+1]=ye}}),P.setAttribute("position",new An(O,3)),P.setAttribute("aActive",new An(ce,1)),_.uniforms.uTime.value=performance.now()*.001,N.uniforms.uTime.value=performance.now()*.001,x.render(w,A),z++;const re=performance.now();re-U>1e3&&(d(z),z=0,U=re)}),Se=()=>{const R=y();A.left=-R.width/2,A.right=R.width/2,A.top=R.height/2,A.bottom=-R.height/2,A.updateProjectionMatrix()},E=new ResizeObserver(()=>{Se()});return g?window.addEventListener("resize",Se):E.observe(m),()=>{Y(),window.removeEventListener("resize",Se),E.disconnect(),x.dispose(),m.contains(x.domElement)&&m.removeChild(x.domElement)}},[n,r,s]);const p=s==="fullscreen"?"fixed inset-0 -z-10 bg-[#020202] pointer-events-none":"relative w-full h-full min-h-[300px] overflow-hidden rounded-xl border border-white/5 jk-glass pointer-events-none";return oe.jsxs("div",{ref:a,className:`${p} ${e}`,children:[oe.jsx("div",{className:"absolute inset-0 opacity-[0.03] pointer-events-none bg-[url('https://grainy-gradients.vercel.app/noise.svg')]"}),s==="fullscreen"&&oe.jsxs("div",{className:"absolute top-4 right-6 font-mono text-[9px] tracking-widest text-neo-accent opacity-30 select-none",children:["SYSTEM_LOAD: ",f," FPS // ",r.toUpperCase(),"_MODE"]})]})},bE=({children:s,showScanlines:e=!0})=>(Ws(),oe.jsxs("div",{className:"jk-layout-v2 relative min-h-screen bg-transparent text-white font-outfit selection:bg-neo-accent selection:text-black",children:[oe.jsx(xg,{}),oe.jsx("div",{className:"fixed inset-0 bg-black/40 pointer-events-none z-0"}),e&&oe.jsx("div",{className:"jk-scanline"}),oe.jsx("div",{className:"fixed inset-0 pointer-events-none border-[1px] border-white/5 z-[99]"}),oe.jsx("div",{className:"relative z-10",children:s})]})),LE=({children:s,showScanlines:e=!0})=>oe.jsx(Bm,{children:oe.jsx(bE,{showScanlines:e,children:s})}),yg=Object.freeze(Object.defineProperty({__proto__:null,NeoButton:d_,NeoCard:h_,NeoInput:p_,NeoLayout:LE,NeuralBackground:xg,NeuralEngine:km,SystemContext:Yf,SystemProvider:Bm,useSystem:Ws},Symbol.toStringTag,{value:"Module"})),{NeoLayout:DE,NeoButton:Ns,NeoCard:ni,NeoInput:Im,useSystem:Sg,NeuralBackground:NE}=yg,Oo=({icon:s,active:e=!1})=>{const{engine:n}=Sg(),r=a=>{if(n){const u=a.currentTarget.getBoundingClientRect();n.emitPulse(u.left+u.width/2,u.top+u.height/2,1.5)}};return oe.jsx("div",{onClick:r,className:`w-12 h-12 flex items-center justify-center rounded-xl cursor-pointer transition-all duration-300 ${e?"bg-neo-accent text-black":"text-white/40 hover:bg-white/5 hover:text-white"}`,children:oe.jsx("span",{className:"text-xl",children:s})})},kr=({title:s,time:e,status:n="info"})=>oe.jsxs("div",{className:"flex items-start gap-4 p-3 rounded-lg hover:bg-white/5 transition-colors border border-transparent hover:border-white/5 jk-glass",children:[oe.jsx("div",{className:`w-1.5 h-6 rounded-full mt-0.5 ${n==="success"?"bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.5)]":n==="warning"?"bg-yellow-500 shadow-[0_0_10px_rgba(234,179,8,0.5)]":"bg-neo-accent shadow-[0_0_10px_var(--neo-glow)]"}`}),oe.jsxs("div",{className:"flex flex-col",children:[oe.jsx("span",{className:"text-[11px] font-bold text-white/80 uppercase tracking-wider",children:s}),oe.jsxs("span",{className:"text-[9px] font-mono text-white/30 uppercase",children:[e," // SYSTEM_SECURE"]})]})]});function IE(){const{theme:s,setTheme:e,engine:n}=Sg(),[r,a]=on.useState({energy:0,nodes:0}),[u,f]=on.useState("showcase"),[d,p]=on.useState(new Date().toLocaleTimeString());on.useEffect(()=>{const x=setInterval(()=>p(new Date().toLocaleTimeString()),1e3);return()=>clearInterval(x)},[]),on.useEffect(()=>n?n.subscribe(y=>{a({energy:y.totalEnergy,nodes:y.nodes.filter(S=>S.energy>.1).length})}):void 0,[n]);const m=()=>oe.jsxs("div",{className:"max-w-[1200px] mx-auto space-y-12 py-16 px-4 fade-in",children:[oe.jsxs("div",{className:"flex flex-col md:flex-row items-center justify-between gap-8 mb-12",children:[oe.jsxs("div",{className:"flex flex-col items-center md:items-start space-y-1",children:[oe.jsx("div",{className:"text-5xl font-black tracking-[0.3em] text-white uppercase drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]",children:"JEIKEI"}),oe.jsx("div",{className:"text-[10px] tracking-[0.8em] text-white/40 uppercase ml-1",children:"LIVING_INTERFACE_v2.0"})]}),oe.jsxs("div",{className:"flex items-center gap-6",children:[oe.jsxs("div",{className:"flex gap-2 p-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md",children:[oe.jsx("button",{onClick:()=>e("nebula"),className:`px-6 py-2 rounded-full text-[9px] font-bold uppercase tracking-widest transition-all ${s==="nebula"?"bg-neo-accent text-black shadow-neon-primary":"text-white/40 hover:text-white"}`,children:"NEBULA"}),oe.jsx("button",{onClick:()=>e("mission"),className:`px-6 py-2 rounded-full text-[9px] font-bold uppercase tracking-widest transition-all ${s==="mission"?"bg-neo-accent text-black shadow-neon-primary":"text-white/40 hover:text-white"}`,children:"MISSION"})]}),oe.jsx(Ns,{variant:"primary",size:"md",onClick:()=>f("dashboard"),children:"GO TO DASHBOARD"})]})]}),oe.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:[oe.jsx(ni,{title:"System Energy",value:`${r.energy.toFixed(1)}GW`,trend:{value:"+12.4%",direction:"up"},children:"Active neural propagation energy detected in the global system grid."}),oe.jsx(ni,{title:"Neural Activity",value:r.nodes.toString(),trend:{value:"OPTIMAL",direction:"neutral"},children:"Currently active high-energy nodes reacting to user interaction."}),oe.jsx(ni,{title:"Global Latency",value:"12ms",trend:{value:"-2ms",direction:"up"},children:"Propagating pulses through the graph engine at sub-millisecond speeds."})]}),oe.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-8 items-start",children:[oe.jsx(ni,{title:"Pulse Emission Test",children:oe.jsxs("div",{className:"space-y-6 pt-4",children:[oe.jsx("p",{className:"text-white/40 text-[11px] leading-relaxed uppercase tracking-wider",children:"Interact with the components below to trigger real-time neural ripples."}),oe.jsxs("div",{className:"flex flex-wrap gap-4",children:[oe.jsx(Ns,{variant:"primary",size:"md",children:"Emit Signal"}),oe.jsx(Ns,{variant:"secondary",size:"md",children:"Calibrate"}),oe.jsx(Ns,{variant:"outline",size:"md",children:"Reset"})]})]})}),oe.jsx(ni,{title:"Data Input Sync",children:oe.jsxs("div",{className:"space-y-6 pt-4",children:[oe.jsx(Im,{label:"Network Identifier",placeholder:"Enter system hash..."}),oe.jsx(Im,{label:"Propagation Intensity",placeholder:"1.25"})]})})]})]}),g=()=>oe.jsxs("div",{className:"flex h-screen w-full overflow-hidden fade-in relative z-20",children:[oe.jsxs("div",{className:"w-20 flex flex-col items-center py-8 gap-8 border-r border-white/5 jk-glass relative z-50",children:[oe.jsx("div",{className:"w-10 h-10 bg-neo-accent flex items-center justify-center rounded-lg shadow-neon-primary text-black font-black text-xl mb-4",children:"JK"}),oe.jsx(Oo,{icon:"⟁",active:!0}),oe.jsx(Oo,{icon:"⦿"}),oe.jsx(Oo,{icon:"⧖"}),oe.jsx(Oo,{icon:"⚙"}),oe.jsx("div",{className:"mt-auto",children:oe.jsx(Oo,{icon:"⏻"})})]}),oe.jsxs("div",{className:"flex-1 flex flex-col relative overflow-y-auto",children:[oe.jsxs("div",{className:"h-20 flex items-center justify-between px-10 border-b border-white/5 jk-glass sticky top-0 z-40",children:[oe.jsxs("div",{className:"flex flex-col",children:[oe.jsx("span",{className:"jk-hud-heading text-neo-accent text-xs",children:"Command Center"}),oe.jsx("span",{className:"text-[10px] font-mono text-white/30 uppercase tracking-[0.4em]",children:"SYSTEM_VERSION_2.0.4 // LOCAL_HOST"})]}),oe.jsxs("div",{className:"flex items-center gap-8",children:[oe.jsxs("div",{className:"flex flex-col items-end",children:[oe.jsx("span",{className:"text-xl font-mono text-white font-bold tracking-tighter",children:d}),oe.jsx("span",{className:"text-[9px] text-white/20 uppercase tracking-widest font-bold",children:"Universal Time Standard"})]}),oe.jsx("div",{className:"h-8 w-[1px] bg-white/10"}),oe.jsx(Ns,{variant:"outline",size:"sm",onClick:()=>f("showcase"),children:"EXIT TO SHOWCASE"})]})]}),oe.jsxs("div",{className:"p-8 space-y-8",children:[oe.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6",children:[oe.jsx(ni,{title:"Energy Output",value:`${r.energy.toFixed(2)}`,className:"py-4 px-6 scale-[0.95]",trend:{value:"+4.2%",direction:"up"}}),oe.jsx(ni,{title:"Active Segments",value:"84",className:"py-4 px-6 scale-[0.95]",trend:{value:"STABLE",direction:"neutral"}}),oe.jsx(ni,{title:"Node Density",value:`${(r.nodes/10).toFixed(1)}%`,className:"py-4 px-6 scale-[0.95]",trend:{value:"-0.8%",direction:"down"}}),oe.jsx(ni,{title:"Pulse Speed",value:"2.1ms",className:"py-4 px-6 scale-[0.95]",trend:{value:"+0.1",direction:"up"}})]}),oe.jsxs("div",{className:"grid grid-cols-1 xl:grid-cols-3 gap-8 h-full",children:[oe.jsx("div",{className:"xl:col-span-2 space-y-6",children:oe.jsxs(ni,{title:"Dynamic Neural Topology",className:"h-[500px] border-neo-accent/20 relative group",children:[oe.jsx("div",{className:"absolute inset-0 overflow-hidden rounded-xl bg-black",children:oe.jsx(NE,{mode:"contained"})}),oe.jsxs("div",{className:"relative z-10 w-full h-full flex flex-col justify-between pointer-events-none",children:[oe.jsxs("div",{className:"flex justify-between items-start",children:[oe.jsxs("div",{className:"p-4 border border-white/5 rounded-lg jk-glass backdrop-blur-md",children:[oe.jsx("div",{className:"jk-data-label text-neo-accent mb-1",children:"Grid Coordinates"}),oe.jsx("div",{className:"text-lg font-mono text-white tracking-widest",children:"34.09 // 118.24"})]}),oe.jsxs("div",{className:"flex gap-2 p-2 bg-black/40 rounded-full border border-white/5",children:[oe.jsx("div",{className:"w-2 h-2 rounded-full bg-green-500 animate-ping mt-1"}),oe.jsx("span",{className:"jk-data-label text-green-500",children:"Live_Stream"})]})]}),oe.jsx("div",{className:"flex justify-center items-center py-20 opacity-0 group-hover:opacity-100 transition-opacity",children:oe.jsxs("div",{className:"relative",children:[oe.jsx("div",{className:"absolute -inset-20 bg-neo-accent/5 rounded-full blur-3xl animate-pulse"}),oe.jsx("div",{className:"text-8xl font-black text-white/5 tracking-tighter select-none uppercase",children:"Topology"})]})}),oe.jsx("div",{className:"flex gap-4 p-4 border-t border-white/5",children:oe.jsxs("div",{className:"flex-1",children:[oe.jsx("div",{className:"jk-data-label mb-2",children:"Propagation Field"}),oe.jsx("div",{className:"w-full h-1.5 bg-white/5 rounded-full overflow-hidden",children:oe.jsx("div",{className:"h-full bg-neo-accent shadow-neon-primary",style:{width:"65%"}})})]})})]})]})}),oe.jsx("div",{className:"space-y-6",children:oe.jsxs(ni,{title:"System Activity Feed",className:"h-full",children:[oe.jsxs("div",{className:"space-y-2 mt-4",children:[oe.jsx(kr,{title:"Neural Handshake Verified",time:"14:02:11",status:"success"}),oe.jsx(kr,{title:"Energy Spike Detected (Sector 7)",time:"14:01:45",status:"warning"}),oe.jsx(kr,{title:"Kernel Optimization Complete",time:"13:58:20",status:"success"}),oe.jsx(kr,{title:"Pulse Buffer Reallocated",time:"13:55:12"}),oe.jsx(kr,{title:"External Request Blocked",time:"13:52:01",status:"warning"}),oe.jsx(kr,{title:"Heartbeat Sync Optimal",time:"13:48:59",status:"success"}),oe.jsx(kr,{title:"User Session Initiated",time:"13:45:33"})]}),oe.jsxs("div",{className:"mt-8 p-4 jk-glass rounded-xl border-neo-accent/20",children:[oe.jsx("div",{className:"jk-hud-heading text-neo-accent text-[9px] mb-2",children:"Security Override"}),oe.jsx(Ns,{variant:"primary",size:"sm",className:"w-full",children:"Request Auth"})]})]})})]})]})]})]});return oe.jsxs(DE,{showScanlines:!0,children:[oe.jsx("style",{children:`
        .fade-in { animation: fadeIn 0.8s ease-out forwards; }
        @keyframes fadeIn { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
      `}),u==="showcase"?m():g()]})}const{SystemProvider:UE}=yg;c_.createRoot(document.getElementById("root")).render(oe.jsx(r_.StrictMode,{children:oe.jsx(UE,{children:oe.jsx(IE,{})})}));
