...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-H6RYRR3L.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-C25NMZGU.js"), act = await getAct();
...
//# sourceMappingURL=chunk-OKUJWSP2.js.map
