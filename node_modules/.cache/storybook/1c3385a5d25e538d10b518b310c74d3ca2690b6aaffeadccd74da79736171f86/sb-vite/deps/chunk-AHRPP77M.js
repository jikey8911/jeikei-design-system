import {
  require_jsx_runtime
} from "./chunk-IPTNJDAD.js";
import {
  require_react_dom
} from "./chunk-BSLPHOG7.js";
import {
  Wu,
  Ya,
  br,
  ...
  ve,
  vr
} from "./chunk-5BN4TW2B.js";
import {
  require_react
} from "./chunk-TVJODQ25.js";
import {
  D
} from "./chunk-7VSLV53X.js";
import {
  __require,
  __toESM
...
var q5 = S(() => {
  ...
  ab = [
    ...
    let r = W5.forwardRef((n, o) => {
      ...
      return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime2.jsx)(u, { ...l, ref: o });
    });
...
function Z5(e, t = []) {
  ...
  function n(i, l) {
    ...
    r = [...r, l];
    function p(h6) {
      let { scope: f, children: g, ...w } = h6, m = f?.[e][c] || u, v = zt.useMemo(() => w, Object.values(w));
...
function uk(e, t) {
  let { originalText: r, [/* @__PURE__ */ Symbol.for("comments")]: n, locStart: o, locEnd: i, [/* @__PURE__ */ Symbol.for("printedComments")]: l } = t, { node: u } = e, c = o(
    u
  ), p = i(u);
...
async function Dg(e, t) {
  let r = e.comments ?? [];
  t[/* @__PURE__ */ Symbol.for("comments")] = r, t[/* @__PURE__ */ Symbol.for("tokens")] = e.tokens ?? [], t[/* @__PURE__ */ Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), iF(
    e,
    t
  );
...
async function Eg(e, t, r = 0) {
  ...
  let u = t[/* @__PURE__ */ Symbol.for("comments")];
  if (t.cursorOffset >= 0) {
    let c, p, d, h6;
...
`) && (t = t.slice(0, -1))), ht.prototype.equals.call(this, e, t, r);
  ...
  a(VA, "Gr");
  a(sl, "me");
  $e = /* @__PURE__ */ Symbol("MODE_BREAK"), kt = /* @__PURE__ */ Symbol("MODE_FLAT"), ho = /* @__PURE__ */ Symbol("cursor"), Hc = /* @__PURE__ */ Symbol("DOC_FILL_PRINTED_LENGTH");
  a(rg, "Kr");
  a(jA, "zu");
  a(WA, "Gu");
  a(zc, "Pt");
...
in order for it to be formatted.`,
  ...
  }, "mn"), wo = hl(Uc(), 1), dg = /* @__PURE__ */ Symbol.for("vnopts.VALUE_NOT_EXIST"), cl = /* @__PURE__ */ Symbol.for("vnopts.VALUE_UNCHANGED"), Em = " ".repeat(2), RF = a((e, t, r) => {
  ...
  if (E) {
    if (i) {
      var V, ee = x === "y" ? oe : ie, I = x === "y" ? he : ue, T = x === "y" ? "height" : "width", P = E[x], q = P + v[ee], $ = P - v[I], U = g ? -F[T] / 2 : 0, H = b === Zt ? R[T] : F[T], X = b === Zt ? -F[T] : -R[T], _e = t.elements.arrow, xe = g && _e ? ln(_e) : {
        ...
        R[T],
        xe[T]
      ), ia = D6 ? R[T] / 2 - U - He - Ae - k.mainAxis : H - He - Ae - k.mainAxis, la = D6 ? -R[T] / 2 + U + He + Pe + k.mainAxis : X + He + Pe + k.mainAxis, us = t.elements.arrow && yt(t.elements.arrow), K3 = us ? x === "y" ? us.clientTop || 0 : us.clientLeft || 0 : 0, cp = (V = B?.[x]) != null ? V : 0, J3 = P + ia - cp - K3, Q3 = P + la - cp, pp = un(g ? an(q, J3) : q, P, g ? bt($, Q3) : $);
      E[x] = pp, j6[x] = pp - P;
    }
    if (u) {
      var dp, e7 = x === "x" ? oe : ie, t7 = x === "x" ? he : ue, Sr = E[C], li = C === "y" ? "height" : "width", fp = Sr + v[e7], hp = Sr - v[t7], cs = [oe, ie].indexOf(y) !== -1, mp = (dp = B?.[C]) != null ? dp : 0, gp = cs ? fp : Sr - R[li] - F[li] - mp + k.altAxis, vp = cs ? Sr + R[li] + F[li] - mp - k.altAxis : hp, wp = g && cs ? Tv(gp, Sr, vp) : un(g ? gp : fp, Sr, g ? vp : hp);
      E[C] = wp, j6[C] = wp - Sr;
    }
...
function Wg(e, t = []) {
  ...
  function n(i, l) {
    ...
    r = [...r, l];
    let p = a((h6) => {
      let { scope: f, children: g, ...w } = h6, m = f?.[e]?.[c] || u, v = nt.useMemo(() => w, Object.values(w));
...
var wL = /* @__PURE__ */ Symbol("radix.slottable");
function bL(e) {
...
var Ye = CL.reduce((e, t) => {
  let r = Yg(`Primitive.${t}`), n = Xg.forwardRef((o, i) => {
    ...
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime8.jsx)(c, { ...u, ref: i });
  });
...
var c0 = re.forwardRef(
  (e, t) => {
    let {
      ...
      onDismiss: u,
      ...c
    } = e, p = re.useContext(n4), [d, h6] = re.useState(null), f = d?.ownerDocument ?? globalThis?.document, [, g] = re.useState({}), w = mt(
      t,
      (R) => h6(R)
...
${t}`);
  ...
  return import_react25.default.createElement(import_react25.Fragment, null, import_react25.default.createElement("span", null, n), ": ", import_react25.default.createElement(
    ...
    (u, c) => u?.name ? import_react25.default.createElement(import_react25.Fragment, { key: c }, "  ", "at ", import_react25.default.createElement(AI, null, u.name), " (", import_react25.default.createElement(av, null, u.location), ")", import_react25.default.createElement("br", null)) : import_react25.default.createElement(
      import_react25.Fragment,
      { key: c },
      "  ",
      "at ",
      import_react25.default.createElement(av, null, u?.location),
...
//# sourceMappingURL=chunk-AHRPP77M.js.map
