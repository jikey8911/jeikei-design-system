...
export const NeuralGrid = ({
  ...
  useEffect(() => {
    ...
    const updateGeometry = () => {
      ...
      lineGeo.getAttribute('alpha').needsUpdate = true;
    ...
    const pointer = (e) => {
      ...
      engine.attract({ x: e.clientX - rect.left, y: e.clientY - rect.top });
      if (followMouse) engine.microPulse({ x: e.clientX - rect.left, y: e.clientY - rect.top });
    };
    const click = (e) => {
